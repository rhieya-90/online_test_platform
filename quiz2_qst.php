...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT question FROM questions2 WHERE 
        `question`='" . $question . "'";
    ...
    if (sizeof($errors) == 0) {
        $sql = "INSERT INTO questions2( `question`,`q_id`, `option1`, `option2`, `option3`, `option4`, `correct`)VALUES
...
<?php include('header.php'); ?>
    <div class="container">
    <h1 class="text-center text-primary">Online Quiz2 Question</h1><br>
        <ul class="content-box-tabs">
            <li><a href="manage.php?name=quiz2" class="default-tab">Manage</a></li> <!-- href must be unique and match the id of target div -->
            <li><a href="quiz2_qst.php">Add</a></li>
        </ul>
